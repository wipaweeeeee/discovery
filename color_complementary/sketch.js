...
var main = 360;
var s1 = new Rune.Color('hsv',main,100,100);
var s2 = new Rune.Color('hsv',main+180,100,100);
for(var y = 0; y<660; y = y+120) {
for(var x = 0; x<660; x = x+120) {
for(var i = 0; i<360; i = i + 90) {

r.rect(x,y,60,60).fill(255).stroke(false).rotate(0+i,x,y);
...
var line4 = r.polygon(x,y)
			 ...
			 .lineTo(20,60)
			 .lineTo(10,60)
			 .fill(s1).stroke(false).rotate(0+i,x,y);
